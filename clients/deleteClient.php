...
// Vérifier si la Client est utilisée dans des réservations
...
if (isset($_POST['confirm']) && $_POST['confirm'] === 'yes') {
    // Si la Client a des réservations et que l'utilisateur souhaite les supprimer aussi
    if ($hasReservations && isset($_POST['delete_reservations']) && $_POST['delete_reservations'] === 'yes') {
        ...
        // Si la Client a des réservations mais l'utilisateur ne veut pas les supprimer
